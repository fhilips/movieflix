...
public class MovieResources {
    ...
    public ResponseEntity<List<ReviewDTO>> findMovieReviewsById(@PathVariable Long id) throws Exception{		
		
		List<ReviewDTO> movieReviews = service.findMovieReviewsById(id);
